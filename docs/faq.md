...
[OpenBullet](https://github.com/openbullet/openbullet) is no longer supported, and it will not receive any more updates. It is strongly recommended to switch to OpenBullet 2, which also supports old OpenBullet `.loli` configs.
