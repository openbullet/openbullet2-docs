...
<DotnetDownloadButton version="10.0" fileName="windowsdesktop-runtime-win-x64.exe">Desktop Runtime (win-x64)</DotnetDownloadButton>
...
If you don't have the latest [.NET Desktop Runtime](https://aka.ms/dotnet/10.0/windowsdesktop-runtime-win-x64.exe) installed on your system, the updater will prompt you to install it. **This is required to run OpenBullet 2 (Native).**
...
If the program closes immediately, it means that the [.NET Desktop Runtime](https://aka.ms/dotnet/10.0/windowsdesktop-runtime-win-x64.exe) was not installed correctly.
...
2. If you don't have it, download the [.NET Desktop Runtime for win-arm64](https://aka.ms/dotnet/10.0/windowsdesktop-runtime-win-arm64.exe) and install it.
...
2. If you don't have it, download the [.NET Desktop Runtime for win-x86](https://aka.ms/dotnet/10.0/windowsdesktop-runtime-win-x86.exe) and install it.
3. Holding down the SHIFT key on your keyboard, right-click an **empty** space inside the folder and select *Open PowerShell window here*.
4. Type the following command and press ENTER:
```bash
dotnet ./OpenBullet2.Native.dll
