...
If the program closes immediately, it means that the [.NET Runtime](https://aka.ms/dotnet/8.0/aspnetcore-runtime-win-x64.exe) and [ASP.NET Core Runtime](https://aka.ms/dotnet/8.0/aspnetcore-runtime-win-x64.exe) were not installed correctly.
