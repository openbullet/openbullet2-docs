...
You will need to **create** a proxy group and give it a name. Once you created a proxy group, you can **import some proxies**, which will be added to the selected group.
...
When using any of these sources, there needs to be only **one proxy per line**.
