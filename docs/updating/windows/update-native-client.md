...
When you see this button on the home page, it means it's time to update your client.
...
## Troubleshooting
### The update fails
Make sure the update completes successfully by reading the console prompts. The download of the new version might take some time, so please wait until all the steps are completed. In case the update fails, you can:
